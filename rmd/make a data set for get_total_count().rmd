...
subway_make_list <- data.frame(matrix(0,1,467))
...
for(i in ind4){
subway_route2[[null_route_name[i]]] <- rbind(get_path(depart = null_route$depart[i], depart_line = null_route$depart_line[i],arrival="응암",arrival_line="6"), get_path( depart = "응암", depart_line="6", arrival=null_route$arrival[i], arrival_line =null_route$arrival_line[i]))
}

for(i in ind5){
subway_route2[[null_route_name[i]]] <- rbind(get_path(depart = null_route$depart[i], depart_line = null_route$depart_line[i],"구파발","3"),data.frame(Path="지축",ind="57"))
}

for(i in ind6){
subway_route2[[null_route_name[i]]] <- rbind(get_path(depart = null_route$depart[i], depart_line = null_route$depart_line[i],"영등포구청","5"),get_path(depart = "영등포구청", depart_line = "5", arrival=null_route$arrival[i], arrival_line =null_route$arrival_line[i]))

}

for(i in ind3){
subway_route2[[null_route_name[i]]] <- get_path(depart = null_route$depart[i], depart_line = "6-A", arrival=null_route$arrival[i], arrival_line =null_route$arrival_line[i])
}
