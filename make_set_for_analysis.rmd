...
null_route <-names(subway_route2)[null_index]
null_route <- as.data.frame(null_route)
...
i<-1
shortestpath(null_route$depart[i], null_route$depart_line[i], null_route$arrival[i], null_route$arrival_line[i])
