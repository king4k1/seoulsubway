...
a <- rep(0,37600)
for(i in 1:37600){
  a[i] <- nrow(subway_route[[i]])
}

a[which(a==1)]
k <- rep(0,1249)
for(i in 1:1249){
k[i] <- isTRUE(subway_route[[which(a==1)[i]]][1,1]=="no result")
}

subway_route[[paste0(seoul_route[1,]$Name,"(",seoul_route[1,]$Line,")",
                            "-",seoul_route[113,]$Name,"(",seoul_route[113,]$Line,")")]]
